...
const AdminPanel = () => {
  ...
  useEffect(() => {
    ...
    if (user.role !== 'admin') {
      ...
      try {
        ...
        const response = await axios.get('https://backend-4i57smi4t-chathura-chandrasiris-projects.vercel.app/api/v1/magazine/pending', {
          headers: {
  ...
  const handleApprove = async (id) => {
    try {
      ...
      await axios.put(`https://backend-4i57smi4t-chathura-chandrasiris-projects.vercel.app/api/v1/magazine/approve/${id}`, {}, {
        headers: {
          Authorization: `Bearer ${token}`, // Include the token in the request headers
        },
        withCredentials: true,
